...
void register_all_configuration_properties() {
    ...
    std::call_once(once, []() {
        ConfigurationPropertiesFactory<
            gateway::GatewayConfig>::create_and_register();
        ConfigurationPropertiesFactory<
            metrics::PrometheusConfig>::create_and_register();
        ...
        ConfigurationPropertiesFactory<
            actor::ActorSystemConfig>::create_and_register();
        ConfigurationPropertiesFactory<log::LogConfig>::create_and_register();

        ConfigurationPropertiesFactory<
            discovery::DiscoveryConfig>::create_and_register();
        ConfigurationPropertiesFactory<
            script::LuaVMPoolConfigProperties>::create_and_register();
    });
}
