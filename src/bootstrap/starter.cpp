...
bool run_starters(Phase phase) {
    ...
    switch (phase) {
        case Phase::PRE_INIT: phase_name = "PRE_INIT"; break;
        case Phase::POST_SYSTEM_INIT: phase_name = "POST_SYSTEM_INIT"; break;
        case Phase::POST_CONFIG: phase_name = "POST_CONFIG"; break;
        case Phase::POST_START: phase_name = "POST_START"; break;
        case Phase::PRE_SHUTDOWN: phase_name = "PRE_SHUTDOWN"; break;
        case Phase::POST_SHUTDOWN: phase_name = "POST_SHUTDOWN"; break;
    }
