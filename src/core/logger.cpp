...
logging::trivial::severity_level to_boost_level(int level) {
    switch (level) {
        case 0: return logging::trivial::trace;
        case 1: return logging::trivial::debug;
        case 2: return logging::trivial::info;
        case 3: return logging::trivial::warning;
        case 4: return logging::trivial::error;
        case 5: return logging::trivial::fatal;
...
void Logger::init(const LogConfig& config) {
    ...
    auto file_sink = logging::add_file_log(
        ...
        logging::keywords::time_based_rotation = sinks::file::rotation_at_time_point(0, 0, 0), // Rotate daily
        logging::keywords::max_files = config.max_files, // Keep max_files files
    ...
    logging::core::get()->set_filter(
        logging::expressions::attr<logging::trivial::severity_level>("Severity") >= to_boost_level(config.level)
    );
