...
public:
    ...
    void add_route(const std::string& method, const std::string& path_pattern, RouteHandler handler);
...
private:
    HttpRequest parse_http_request(const std::string& raw_request, uint64_t connection_id);
