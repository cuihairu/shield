...
public:
  ...
  void send_to(const boost::asio::ip::udp::endpoint &endpoint, const char *data,
               size_t length);
  ...
  // Session management
  uint64_t
  get_or_create_session_id(const boost::asio::ip::udp::endpoint &endpoint);
