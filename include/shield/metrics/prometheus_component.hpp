...
public:
    ...
    std::shared_ptr<SystemMetricsCollector> get_system_collector() const { return system_collector_; }
    std::shared_ptr<NetworkMetricsCollector> get_network_collector() const { return network_collector_; }
    std::shared_ptr<GameMetricsCollector> get_game_collector() const { return game_collector_; }
