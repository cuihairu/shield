...
TEST_F(DistributedActorSystemTest, ActorDiscovery) {
  ...
  EXPECT_TRUE(distributed_system_->register_actor(logic_actor, ActorType::LOGIC,
                                                  "logic_1"));
...
TEST_F(DistributedActorSystemTest, ServiceGroupDiscovery) {
  ...
  EXPECT_TRUE(distributed_system_->register_actor(actor1, ActorType::LOGIC,
                                                  "player_1", "game_players"));
  EXPECT_TRUE(distributed_system_->register_actor(actor2, ActorType::LOGIC,
                                                  "player_2", "game_players"));
