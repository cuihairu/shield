    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Plugin Pool Stats', link: '/plugin-pool-stats' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'CMake 重构（历史）', link: '/cmake-refactor' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'DB 异步 ABI 立项（草案）', link: '/db-async-design' },
          { text: 'Schema 设计（合并稿）', link: '/schema-design' },
          { text: 'Xmldef Toolchain Design', link: '/xmldef-toolchain-design' },
          { text: 'Xmldef Descriptor Spec', link: '/xmldef-descriptor-spec' },
          { text: 'Xmldef Phase 1 Plan', link: '/xmldef-phase1-implementation' },
          { text: 'Xmldef Compiler / Runtime MVP', link: '/xmldef-compiler-runtime-mvp' },
          { text: 'Xmldef Unity Generator Spec', link: '/xmldef-unity-generator-spec' },
        ],
      },
    ],
    outline: 'deep',
